...
sorted_file_path = r'/home/user/zly/daima/UKUQ/result/diedai/train_sorted_file_0_gai.txt'
image_folder = '/home/user/zly/daima/train_clip_0/label/'

lines = []
with open(r'/home/user/zly/daima/UKUQ/result/diedai/train_sorted_file_0.txt', 'r') as file:
...
sorted_file_path = r'/home/user/zly/daima/UKUQ/result/diedai/train_sorted_file_1_gai.txt'
image_folder = '/home/user/zly/daima/train_clip_1/label/'

lines = []
with open(r'/home/user/zly/daima/UKUQ/result/diedai/train_sorted_file_1.txt', 'r') as file:
    lines = file.readlines()
