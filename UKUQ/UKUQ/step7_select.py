...
def main():
    result_dict = {}
    # 从每个txt文件中读取数据
    read_txt(r"/home/user/zly/daima/UKUQ/result/results_classcvaps_0_max_min.txt", result_dict)
    read_txt(r"/home/user/zly/daima/UKUQ/result/results_spectral_0_max_min.txt", result_dict)
    read_txt(r"/home/user/zly/daima/UKUQ/result/result_ssim_index_0_min_max.txt", result_dict)
    read_txt(r"/home/user/zly/daima/UKUQ/result/result_cha_entr_AB_0_max_min.txt", result_dict)
    read_txt(r"/home/user/zly/daima/UKUQ/result/diedai/train_sorted_file_0_gai.txt", result_dict)

    # 计算最接近的行号对
    nearest_indices = calculate_nearest_indices(result_dict)

    # 将结果写入文件
    with open(r"/home/user/zly/daima/UKUQ/result/result_jiejin_0.txt", "w") as f:
...
def main():
    result_dict = {}
    read_txt(r"/home/user/zly/daima/UKUQ/result/results_classcvaps_1_min_max.txt", result_dict)
    read_txt(r"/home/user/zly/daima/UKUQ/result/results_spectral_1_min_max.txt", result_dict)
    read_txt(r"/home/user/zly/daima/UKUQ/result/result_ssim_index_1_min_max.txt", result_dict)
    read_txt(r"/home/user/zly/daima/UKUQ/result/result_cha_entr_AB_1_max_min.txt", result_dict)
    read_txt(r"/home/user/zly/daima/UKUQ/result/diedai/train_sorted_file_1_gai.txt", result_dict)
    nearest_indices = calculate_nearest_indices(result_dict)

    # with open(r"/home/user/zly/daima/UKUQ/result/result_jiejin_1.txt", "w") as f:
    #     for index, (nearest_index1, nearest_index2) in nearest_indices.items():
    #         f.write(f"Image {index}: near = {nearest_index1}，{nearest_index2}\n")
