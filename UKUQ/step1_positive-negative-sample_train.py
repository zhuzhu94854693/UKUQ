...
# 创建数据集实例
data_dir = "D:\zly\data\WHU_clip/orgin/train"
transform = transforms.ToTensor()
dataset = ChangeDetectionDataset(data_dir, transform=transform)
dataloader = DataLoader(dataset, batch_size=1, collate_fn=dataset.collate_fn)

# 创建输出目录
output_dir_0 = "D:\zly\data\WHU_clip/train_clip_0"  # labels为全0的图像对应的images_A、images_B、labels保存的目录
output_dir_1 = "D:\zly\data\WHU_clip/train_clip_1"  # labels不全为0的图像对应的images_A、images_B、labels保存的目录
