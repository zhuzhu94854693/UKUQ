...
with open(r"D:\zly\daima\sample\gongkai\result/results_spectral_1_min_max.txt", "w") as f:
...
with open(r"D:\zly\daima\sample\gongkai\result/results_spectral_0_max_min.txt", "w") as f:
    for index, result in sorted_results:
        f.write(f"Image {index}: OA = {result}\n")
