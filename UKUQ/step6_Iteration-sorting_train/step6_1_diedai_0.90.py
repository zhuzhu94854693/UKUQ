...
def train(loader, num_classes, device, net, optimizer, criterion):
    ...
    for images1, images2, masks in tqdm.tqdm(loader):
        ...
        with open(r"D:\zly\daima\sample\gongkai\result\diedai/pixel_count_train_all_paixu_min_max.txt", "w") as f:
...
if __name__ == '__main__':
    ...
    model_dict = {  'Unet': Unet(input_nbr=6, label_nbr=2).train().to(device),}
...
# 创建数据集实例
data_dir = "D:\zly\data/WHU_clip/all/train"
...
# 保存对应索引的图像
output_folder = r"D:\zly\daima\sample\gongkai\result\diedai\xuanqu_diedai\t0.90_0.90\train"  # 修复文件夹路径错误
