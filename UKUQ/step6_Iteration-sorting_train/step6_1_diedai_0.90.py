...
device = 'cuda'
path = '/home/user/zly/data2/WHU_clip/sample/orgion/'
...
#         with open(r"/home/user/zly/daima/UKUQ/result/diedai/pixel_count_train_all_paixu_min_max.txt", "w") as f:
...
# 保存对应索引的图像
output_folder = r"/home/user/zly/daima/UKUQ/result/diedai/xuanqu_diedai/t0.90_0.90/train"  # 修复文件夹路径错误
