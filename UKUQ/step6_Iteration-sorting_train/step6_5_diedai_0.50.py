...
device = 'cuda'
path = r'/home/user/zly/daima/UKUQ/result/diedai/xuanqu_diedai/t0.60_0.60/'
...
def train(loader, num_classes, device, net, optimizer, criterion):
    ...
    for images1, images2, masks in tqdm.tqdm(loader):
        ...
        with open(r"/home/user/zly/daima/UKUQ/result/diedai/pixel_count_train_0.60_paixu_min_max.txt", "w") as f:
...
# 保存对应索引的图像
output_folder = r"/home/user/zly/daima/UKUQ/result/diedai/xuanqu_diedai/t0.50_0.50/train"  # 修复文件夹路径错误
