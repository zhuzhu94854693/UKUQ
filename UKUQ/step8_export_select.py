...
# 创建数据集实例
data_dir = "D:\zly\data/WHU_clip/train_clip_0"
...
index_list = []
with open(r'D:\zly\daima\sample\gongkai\result/result_jiejin_0.txt', 'r') as file:
    for line in file:
...
# 保存对应索引的图像
output_folder = r"D:\zly\daima\sample\gongkai\result\select\t0.10_0.10\train"  # 修复文件夹路径错误
...
# 保存对应索引的图像
output_folder = r"D:\zly\daima\sample\gongkai\result\select\t0.20_0.20\train"  # 修复文件夹路径错误
if not os.path.exists(output_folder):
    os.makedirs(output_folder)
...
# 保存对应索引的图像
output_folder = r"D:\zly\daima\sample\gongkai\result\select\t0.30_0.30\train"  # 修复文件夹路径错误
if not os.path.exists(output_folder):
    os.makedirs(output_folder)
...
# 保存对应索引的图像
output_folder = r"D:\zly\daima\sample\gongkai\result\select\t0.40_0.40\train"  # 修复文件夹路径错误
if not os.path.exists(output_folder):
    os.makedirs(output_folder)
...
# 保存对应索引的图像
output_folder = r"D:\zly\daima\sample\gongkai\result\select\t0.50_0.50\train"  # 修复文件夹路径错误
if not os.path.exists(output_folder):
    os.makedirs(output_folder)
...
# 保存对应索引的图像
output_folder = r"D:\zly\daima\sample\gongkai\result\select\t0.60_0.60\train"  # 修复文件夹路径错误
if not os.path.exists(output_folder):
    os.makedirs(output_folder)
...
# 保存对应索引的图像
output_folder = r"D:\zly\daima\sample\gongkai\result\select\t0.70_0.70\train"  # 修复文件夹路径错误
if not os.path.exists(output_folder):
    os.makedirs(output_folder)
...
# 保存对应索引的图像
output_folder = r"D:\zly\daima\sample\gongkai\result\select\t0.80_0.80\train"  # 修复文件夹路径错误
if not os.path.exists(output_folder):
    os.makedirs(output_folder)
...
# 保存对应索引的图像
output_folder = r"D:\zly\daima\sample\gongkai\result\select\t0.90_0.90\train"  # 修复文件夹路径错误
if not os.path.exists(output_folder):
    os.makedirs(output_folder)
...
# 创建数据集实例
data_dir = "D:\zly\data/WHU_clip/train_clip_1"
transform = transforms.ToTensor()
dataset = ChangeDetectionDataset(data_dir, transform=transform)
dataloader = DataLoader(dataset, batch_size=len(dataset), collate_fn=dataset.collate_fn)
...
# 读取 final_result.txt 文件中的图像索引
index_list = []
with open(r'D:\zly\daima\sample\gongkai\result/result_jiejin_1.txt', 'r') as file:
    for line in file:
        if line.startswith('Image'):
            index = int(line.split()[1].strip(':'))
            index_list.append(index)
